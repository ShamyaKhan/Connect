  ...
  return (
    user && (
      <div className="flex flex-col h-screen">
        <div
          className="flex items-center gap-2 p-2 md:px-10 xl:pl-42 bg-linear-to-r 
        ...
        <div className="px-4">
          <div
            className="flex items-center gap-3 pl-5 p-1.5 bg-white w-full max-w-xl mx-auto
          ...
          >
            ...
            <button
              className="bg-linear-to-br from-indigo-500 to-purple-600
                       hover:from-indigo-700 hover:to-purple-800 active:scale-90 
